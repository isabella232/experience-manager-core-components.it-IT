...
Consulta la documentazione [](https://github.com/adobe/aemanalyser-maven-plugin/blob/main/aemanalyser-maven-plugin/README.md) Maven Plugin per informazioni su come includerla in un progetto AEM.
...
| `api-regions`<p> </p>`api-regions-check-order`<p> </p>`api-regions-dependencies`<p> </p>`api-regions-duplicates` | Questi analizzatori controllano alcuni dettagli relativi al pacchetto di [contenuti per il processo](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/implementing/deploying/overview.html?lang=en#deploying) di conversione del modello di feature che crea artefatti conformi al modello di feature Sling. Eventuali errori devono essere segnalati  Adobe Assistenza clienti. | Sì | Sì |
