...
| `groupId` |  | ID gruppo Maven di base (ad esempio, `"com.mysite"`). Questo valore deve essere un [nome del pacchetto Java valido.](https://docs.oracle.com/javase/specs/jls/se6/html/packages.html#7.7) |
