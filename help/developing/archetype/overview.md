...
* **Best practice:** Avviate il sito con tutte le procedure consigliate più recenti di Adobe.
* **Codice basso:** Modificate i modelli, create contenuti, distribuite i CSS e il sito è pronto per essere trasmesso in diretta.
* **Pronto per il cloud:** Se lo desiderate, utilizzate [AEM come servizio](https://docs.adobe.com/content/help/en/experience-manager-cloud-service/landing/home.html) cloud per vivere in pochi giorni e semplificare la scalabilità e la manutenzione.
* **Dispatcher:** Un progetto è completo solo con una configurazione [](https://docs.adobe.com/content/help/en/experience-manager-dispatcher/using/dispatcher.html) Dispatcher che ne garantisca la velocità e la sicurezza.
...
* **Layout reattivo:** Nei modelli o nelle singole pagine, [definite il modo in cui gli elementi si ridispongono](https://docs.adobe.com/content/help/en/experience-manager-65/authoring/siteandpage/responsive-layout.html) per i punti di interruzione definiti.
...
* **Build front-end:** I dispositivi front-end possono [mascherare le pagine](uifrontend.md#webpack-dev-server) AEM e [creare librerie](uifrontend.md) client con Webpack, TypeScript e SASS.
...
| Archetype | AEM as a Cloud Service | AEM 6.5 | AEM 6.4 | AEM 6.3 | Java SE | Paradiso |
---------|---------|---------|---------|---------|---------|---------
| [23](https://github.com/adobe/aem-project-archetype/releases/tag/aem-project-archetype-23) | Continuo | 6.5.0.0+ | 6.4.4.0+ | 6.3.3.4+ | 8, 11 | 3.3.9+ |

Imposta l’ambiente di sviluppo locale per [AEM come SDK](https://docs.adobe.com/content/help/en/experience-manager-learn/cloud-service/local-development-environment-set-up/overview.html) di servizio cloud o per le versioni [precedenti di AEM](https://docs.adobe.com/content/help/en/experience-manager-learn/foundation/development/set-up-a-local-aem-development-environment.html).
