...
+ Moduli adattivi {#adaptive-forms}
   ...
   + [Temi di esempio, modelli e modelli di dati dei moduli nei componenti core](/help/adaptive-forms/sample-themes-templates-form-data-models-core-components.md)
