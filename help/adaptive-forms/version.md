...
| [2.0.62](https://github.com/adobe/aem-core-forms-components/releases/tag/core-forms-components-reactor-2.0.62) | Con questa versione viene aggiunto il supporto per il componente Termini e condizioni. È stato aggiunto anche il supporto per il nome qualificato nei componenti core. | Continua | 8, 11 | 16 ottobre 2023 |
...
| [2.0.56](https://github.com/adobe/aem-core-forms-components/releases/tag/core-forms-components-reactor-2.0.56) | Con questa versione viene aggiunto il supporto per le proprietà personalizzate per tutti i Componenti core. | Continua | 8, 11 | 12 settembre 2023 |
