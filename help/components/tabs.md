...
## Scheda e progettazione reattiva {#responsive-design}
...
Alcuni componenti avanzati, come il componente Scheda, possono richiedere una considerazione specifica nel contesto del progetto di implementazione per mantenere la reattività in tutte le condizioni. Per ulteriori informazioni, consulta il documento [Progettazione reattiva dei componenti core](/help/responsive.md).
