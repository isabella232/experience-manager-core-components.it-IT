...
[L’authoring con i componenti](get-started/authoring.md) core descrive l’utilizzo dei componenti core e le funzioni esposte agli autori dei contenuti e agli autori di modelli. Ogni componente è documentato in dettaglio.
...
[Lo sviluppo di componenti](developing/overview.md) di base descrive le funzionalità tecniche dei componenti di base, come utilizzarli nei progetti, come personalizzare e procedure ottimali.
